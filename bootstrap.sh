...
function clone_fonsovim()
{
  # Clone Fonsovim into .vim
  git clone --recursive https://github.com/thefonso/fonsovim.git "${HOME}/.vim" \
...
function main()
{
  if [ ! -e "${HOME}/.vim/fonsovim" -o "$1" == "--force" ]; then
